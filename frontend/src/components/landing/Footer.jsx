...
const COLS = [
  {
    title: "Product",
    links: ["Features", "Demo", "Pricing", "Changelog"],
  },
  {
    title: "Developers",
  ...
  {
    title: "Integrations",
    links: ["Gitlawb", "GitHub", "GitLab", "Bitbucket"],
  },
  {
    title: "Company",
...
export default function Footer() {
  return (
    <footer id="docs" className="relative border-t border-white/[0.06] bg-[#070707]">
      <div className="mx-auto max-w-6xl px-5 sm:px-8 py-14">
        <div className="grid lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2">
            ...
            <div id="gitlawb" className="mt-5 inline-flex items-center gap-2 rounded-lg gs-border bg-white/[0.02] px-3 py-2 text-xs text-neutral-400 font-mono">
